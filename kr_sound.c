...
/*               | 21/02/2015 | La musique doit être dans le dossier sounds  */
/*               |            |                                              */
/* ========================================================================= */
...
Kr_Sound* Kr_Sound_Alloc( const char *szSndName )
{
	...
	pSoundPath = UTIL_BuildPath("sounds", szSndName, iSoundLen, "wav");
...
Mix_Music* Kr_Sound_LoadMusic(const char *szMusicName)
{
	...
	szMusicPath = UTIL_BuildPath("sounds", szMusicName, iPathLen, "mp3"); // Le fichier de la musique doit avoir l'extension .mp3
	if (!szMusicPath)
	{
